 ...
 * 
 */
@WebServiceClient(name = "Servicios", targetNamespace = "http://webService/", wsdlLocation = "http://localhost:8080/SERVER-SERVICE-CRUD/Servicios?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/SERVER-SERVICE-CRUD/Servicios?WSDL");
