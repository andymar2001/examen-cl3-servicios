...
<html lang="es">
    <head>
        ...
        <!--FONTAWESOME-->
        <link rel="stylesheet" href="assets/fontawesome/css/all.min.css?t=1624927214690"/>
        <script src="assets/fontawesome/js/all.min.js?t=1624927214690"></script>
        <!--STYLE BASE-->
        <link rel="stylesheet" href="css/styles.css?t=1624927214690"/>
                ...
                <div class="login-page__container container">
                    ...
                    <div class="form-login">
                        <div class="form-login__group">
                            ...
                            <input class="input" type="text" name="txtFirstName" placeholder="Nombres"/>
                        </div>
                        <div class="form-login__group">
                            <label class="label">Apellidos</label>
                            <input class="input" type="text" name="txtLastName" placeholder="Apellidos"/>
                        </div>
                        <div class="form-login__group">
                            <label class="label">Celular</label>
                            <input class="input" type="text" name="txtPhone" placeholder="Celular"/>
                        </div>
                        <div class="form-login__group">
                        ...
                        <div class="form-login__group">
                            <input class="form-login__button button" type="submit" name="accion" value="Agregar"/>
                        </div>
                    </div>
                </div>
            </form>
